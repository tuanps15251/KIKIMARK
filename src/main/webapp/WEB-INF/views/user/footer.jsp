		...
		<div class="row px-xl-5 pt-5">
			<div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
				...
				<p class="mb-4">No dolore ipsum accusam no lorem. Invidunt sed
					...
					magna amet no</p>
				<p class="mb-2">
					<i class="fa fa-map-marker-alt text-info mr-3"></i>123 Street,
					New York, USA
				</p>
				<p class="mb-2">
					<i class="fa fa-envelope text-info mr-3"></i>poly@fpt.edu.vn
				</p>
				<p class="mb-0">
					<i class="fa fa-phone-alt text-info mr-3"></i>0999921112
				</p>
			</div>
			<div class="col-lg-8 col-md-12">
				<div class="row">
					...
					<div class="col-md-4 mb-5">
						...
						<div class="d-flex">
							<a class="btn btn-info btn-square mr-2" href="#"><i
								class="fab fa-twitter"></i></a> <a
								class="btn btn-info btn-square mr-2" href="#"><i
								class="fab fa-facebook-f"></i></a> <a
								class="btn btn-info btn-square mr-2" href="#"><i
								class="fab fa-linkedin-in"></i></a> <a
								class="btn btn-info	 btn-square" href="#"><i
		...
		<div class="row border-top mx-xl-5 py-4"
			...
			<div class="col-md-6 px-xl-0">
				<p class="mb-md-0 text-center text-md-left text-secondary">
					&copy; <a class="text-info" href="#">Copyright</a>. All Rights
					Reserved. Designed by <a class="text-info">HTML Codex</a>
				</p>
			</div>
